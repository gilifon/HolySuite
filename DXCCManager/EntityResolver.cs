...
namespace DXCCManager
{
    public class EntityResolver
    {
        private List<string> DXCCs = new List<string>()
        {
            ...
            "9[M,W][2,4]~West Malaysia~299~AS~OJ02",
            "9[M,W][6,8]~East Malaysia~46~OC~OJ41",
            ...
            "C[Q-T][3,9]|CQ2~Madeira Is.~256~AF~IM12",
            "(C[Q-T][0,5,6,7])|CT1|CT2|CT4|CQ4~Portugal~272~EU~IM56",
            "CU|CQ[1,8]|CT8~Azores~149~EU~HM49",
