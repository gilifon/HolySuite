...
namespace HolyParser
{
    public class HolyLogParser
    {
        ...
        private bool _isApplyValidation = true;
        public bool IsApplyValidation { get { return _isApplyValidation; } set { _isApplyValidation = value; } }
...
<td style='width:150px; text-align:center'>~POINTS~</td>
        ...
        public HolyLogParser(string rawData, Operator logType, bool isParseDuplicates = true, bool isParseWarc = true, bool isApplyValidation = false )
        {
            m_fileText = rawData;
            LogType = logType;
            IsParseDuplicates = isParseDuplicates;
            IsParseWARC = isParseWarc;
            IsApplyValidation = isApplyValidation;
        ...
        private void PopulateQSOList()
        {
            ...
            foreach (string row in rows)
            {
                ...
                qso_row.StandartizeQSO(IsApplyValidation);
